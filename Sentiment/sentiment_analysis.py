...
fig.update_layout(title="Sentiment Scores for Harvard Commencement Speeches<br>(Microsoft Azure API)", 
...
fig2.update_layout(title="Sentiment Scores per Year From Wikipedia<br>(Microsoft Azure API)", 
                xaxis={'title':{'text':'Year'}}, 
                yaxis={'title':{'text':'Sentiment Distribution'}}, 
                legend={'title':{'text':'Sentiment'}},
                template=theme_hodp)
...
fig.update_layout(
    title="Speech Sentiment vs. Year Summary Sentiment<br>(Microsoft Azure API)", 
    template=theme_hodp
)
